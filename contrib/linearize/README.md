...
## Step 0: Install points_hash

https://github.com/The-Neoxa-Endeavor/points_hash
...
JSON-RPC server. Running `pointsd` or `points-qt -server` will be sufficient.
...
* `input`: pointsd blocks/ directory containing blkNNNNN.dat
