Contributing to Neoxa Core
============================

The Neoxa Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/The-Neoxa-Endeavor/points/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Neoxa Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Neoxa
Network Protocol consensus changes.

Whether a pull request is merged into Neoxa Core rests with the project merge
...
Patches that change Neoxa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Neoxa consensus, it must have been
...
The review process is normally fairly responsive on the Neoxa Core repository, however
...
The project leader is the release manager for each Neoxa Core release.
