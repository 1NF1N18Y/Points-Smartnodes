...
void gobject_vote_conf_help()
{
    throw std::runtime_error(
                ...
                "Vote on a governance object by smartnode configured in points.conf\n"
                "\nArguments:\n"
...
UniValue gobject_vote_conf(const JSONRPCRequest& request)
{
    ...
    if (!dmn) {
        ...
        resultsObj.push_back(Pair("points.conf", statusObj));
...
#endif // ENABLE_WALLET
            "  vote-conf          - Vote on a governance object by smartnode configured in points.conf\n"
#ifdef ENABLE_WALLET
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Neoxa features */
    { "points",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "points",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "points",               "gobject",                &gobject,                true,  {} },
    { "points",               "voteraw",                &voteraw,                true,  {} },
