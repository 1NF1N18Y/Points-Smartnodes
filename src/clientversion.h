...
#error Client version information missing: version is not defined by points-config.h or in any other way
#endif
...
/**
 * pointsd-res.rc includes this file, but it cannot cope with real c++ code.
