...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 200; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
        consensus.nSmartnodePaymentsStartBlock = 10; // 
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.smartnodePaymentFixedBlock = 20;
        ...
        consensus.defaultAssumeValid = uint256S("0x00000057cd8d2f23e72d1266f6eca13bfb3eaf2fc17dfe24d8c68856d3142430"); // 0
   ...
   //   FindMainNetGenesisBlock(1701429301, 0x20001fff, "main");
	    ...
	    assert(consensus.hashGenesisBlock == uint256S("0x000000d21317d68f5253f7ef4cecb163e09d004b598a98be62e857708719fc33"));
        ...
        vector<FounderRewardStructure> rewardStructures = { {100, 15},// 15%
        ...
        chainTxData = ChainTxData{
        	...
        	1710608013, // * UNIX timestamp of last known number of transactions 2021-06-18 22:03:06 UTC
