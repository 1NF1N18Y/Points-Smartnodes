...
* points.conf: contains configuration settings for pointsd or points-qt
* pointsd.pid: stores the process id of pointsd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by pointsd or points-qt
