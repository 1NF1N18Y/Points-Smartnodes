...
"""Verify that starting pointsd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pointsd with -h for help text")
        ...
        self.log.info("Start pointsd with -version for version information")
